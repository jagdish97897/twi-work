                    ...
                    <form onSubmit={handleSubmit} >
                        ...
                        <Tabs className="bg-white mt-4 rounded-lg shadow-lg">
                            <TabList className="flex flex-wrap border-b border-gray-200 bg-indigo-100 rounded-t-lg">
                                ...
                                <Tab className="py-2 px-4 cursor-pointer hover:bg-gray-100 w-full sm:w-auto text-indigo-800">Notifiers</Tab>
                            </TabList>
                                            ...
                                            <tbody>
                                                {items.map((item, index) => (
                                                    <tr key={index}>
                                                        ...
                                                        <td className="border border-black px-4 py-2">{item.mobile}</td>
                            ...
                            <div className="fixed inset-0 flex items-center justify-center z-50 bg-gray-900 bg-opacity-50 overflow-y-auto">
                                <div className="bg-white p-4 rounded-lg shadow-lg w-1/2">
                                    ...
                                    <div className="grid grid-cols-2 gap-4">
                                        ...
                                        <div className="mb-4">
                                            <label className="text-sm mb-1" htmlFor="from">name</label>
                                            <input
                                                type="text"
                                                id="name"
                                                name="name"
                                        ...
                                        <div className="mb-4">
                                            <label className="text-sm mb-1" htmlFor="from">mobile</label>
                                            <input
                                                type="text"
                                                id="mobile"
                                                name="mobile"
