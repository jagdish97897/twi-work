                    ...
                    <form onSubmit={handleSubmit} >
                        ...
                        <div className="space-y-4 bg-[#FFFFFF] p-2  sm:flex sm:flex-wrap gap-2">
                            ...
                            <div className="mb-4">
                                ...
                                <input type="text" id="code" name="code" value={formData.code} onChange={handleChange} className="input w-full border border-black shadow-md" />
                            </div>

                            {/* Last Code */}
                            <div className="mb-4">
                                <label htmlFor="lastCode" className="block text-sm font-medium text-gray-700">Last Code</label>
                                <input type="text" id="lastCode" name="lastCode" value={formData.lastCode} onChange={handleChange} className="input w-full border border-black shadow-md" />
                            </div>
                            ...
                            <div className="mb-4">
                                ...
                                <input type="text" id="printAs" name="printAs" value={formData.printAs} onChange={handleChange} className="input w-full border border-black shadow-md" />
                            </div>

                            {/* Group */}
                            <div className="mb-4">
                                <label htmlFor="group" className="block text-sm font-medium text-gray-700">Group</label>
                                <input type="text" id="group" name="group" value={formData.group} onChange={handleChange} className="input w-full border border-black shadow-md" />
                            </div>

                            {/* Expense Type */}
                            <div className="mb-4">
                                <label htmlFor="expenseType" className="block text-sm font-medium text-gray-700">Expense Type</label>
                                <input type="text" id="expenseType" name="expenseType" value={formData.expenseType} onChange={handleChange} className="input w-full border border-black shadow-md" />
                            </div>

                            {/* Sub Type */}
                            <div className="mb-4">
                                <label htmlFor="subType" className="block text-sm font-medium text-gray-700">Sub Type</label>
                                <input type="text" id="subType" name="subType" value={formData.subType} onChange={handleChange} className="input w-full border border-black shadow-md" />
                            </div>
                            ...
                            <div className="mb-4">
                                ...
                                <input type="text" id="parentAccount" name="parentAccount" value={formData.parentAccount} onChange={handleChange} className="input w-full border border-black shadow-md" />
                            </div>
                        </div>

                        <Tabs className="bg-[#FFFFFF] pt-2">
                            <TabList className="flex flex-wrap border-b border-gray-200">
                                <Tab className="bg-blue-300 py-2 px-4 cursor-pointer hover:bg-gray-100 w-full sm:w-auto">Contact</Tab>
                                <Tab className="bg-blue-300 py-2 px-4 cursor-pointer hover:bg-gray-100 w-full sm:w-auto">Correct Address</Tab>
                                <Tab className="bg-blue-300 py-2 px-4 cursor-pointer hover:bg-gray-100 w-full sm:w-auto">GST</Tab>
                                <Tab className="bg-blue-300 py-2 px-4 cursor-pointer hover:bg-gray-100 w-full sm:w-auto">TDS</Tab>
                                <Tab className="bg-blue-300 py-2 px-4 cursor-pointer hover:bg-gray-100 w-full sm:w-auto">ITR</Tab>
                                <Tab className="bg-blue-300 py-2 px-4 cursor-pointer hover:bg-gray-100 w-full sm:w-auto">General Details</Tab>
                                <Tab className="bg-blue-300 py-2 px-4 cursor-pointer hover:bg-gray-100 w-full sm:w-auto">Bank Details</Tab>
                            </TabList>
                            ...
                            <TabPanel>
                                <div className="grid grid-cols-6 gap-6 p-2">
                                    ...
                                    <div className="col-span-6 sm:col-span-3">
                                        ...
                                        <input type="text" id="contact.Address" name="contact.Address" value={formData.contact.Address} onChange={handleContactChange} className="input w-full border border-black shadow-md" />
                                    </div>
                                    {/* City */}
                                    <div className="col-span-6 sm:col-span-3">
                                        <label htmlFor="contact.City" className="block text-sm font-medium text-gray-700">City</label>
                                        <input type="text" id="contact.City" name="contact.City" value={formData.contact.City} onChange={handleContactChange} className="input w-full border border-black shadow-md" />
                                    </div>
                                    {/* PIN */}
                                    <div className="col-span-6 sm:col-span-3">
                                        <label htmlFor="contact.PIN" className="block text-sm font-medium text-gray-700">PIN</label>
                                        <input type="text" id="contact.PIN" name="contact.PIN" value={formData.contact.PIN} onChange={handleContactChange} className="input w-full border border-black shadow-md" />
                                    </div>
                                    {/* State */}
                                    <div className="col-span-6 sm:col-span-3">
                                        <label htmlFor="contact.State" className="block text-sm font-medium text-gray-700">State</label>
                                        <input type="text" id="contact.State" name="contact.State" value={formData.contact.State} onChange={handleContactChange} className="input w-full border border-black shadow-md" />
                                    </div>
                                    {/* Country */}
                                    <div className="col-span-6 sm:col-span-3">
                                        <label htmlFor="contact.Country" className="block text-sm font-medium text-gray-700">Country</label>
                                        <input type="text" id="contact.Country" name="contact.Country" value={formData.contact.Country} onChange={handleContactChange} className="input w-full border border-black shadow-md" />
                                    </div>
                                    {/* Person */}
                                    <div className="col-span-6 sm:col-span-3">
                                        <label htmlFor="contact.Person" className="block text-sm font-medium text-gray-700">Person</label>
                                        <input type="text" id="contact.Person" name="contact.Person" value={formData.contact.Person} onChange={handleContactChange} className="input w-full border border-black shadow-md" />
                                    </div>
                                    {/* Landline */}
                                    <div className="col-span-6 sm:col-span-3">
                                        <label htmlFor="contact.Landline" className="block text-sm font-medium text-gray-700">Landline</label>
                                        <input type="text" id="contact.Landline" name="contact.Landline" value={formData.contact.Landline} onChange={handleContactChange} className="input w-full border border-black shadow-md" />
                                    </div>
                                    {/* Designation */}
                                    <div className="col-span-6 sm:col-span-3">
                                        <label htmlFor="contact.Designation" className="block text-sm font-medium text-gray-700">Designation</label>
                                        <input type="text" id="contact.Designation" name="contact.Designation" value={formData.contact.Designation} onChange={handleContactChange} className="input w-full border border-black shadow-md" />
                                    </div>
                                    {/* Mobile */}
                                    <div className="col-span-6 sm:col-span-3">
                                        <label htmlFor="contact.Mobile" className="block text-sm font-medium text-gray-700">Mobile</label>
                                        <input type="text" id="contact.Mobile" name="contact.Mobile" value={formData.contact.Mobile} onChange={handleContactChange} className="input w-full border border-black shadow-md" />
                                    </div>
                                    {/* Email */}
                                    <div className="col-span-6 sm:col-span-3">
                                        <label htmlFor="contact.Email" className="block text-sm font-medium text-gray-700">Email</label>
                                        <input type="text" id="contact.Email" name="contact.Email" value={formData.contact.Email} onChange={handleContactChange} className="input w-full border border-black shadow-md" />
                                    </div>
                                    {/* Fax */}
                                    <div className="col-span-6 sm:col-span-3">
                                        <label htmlFor="contact.Fax" className="block text-sm font-medium text-gray-700">Fax</label>
                                        <input type="text" id="contact.Fax" name="contact.Fax" value={formData.contact.Fax} onChange={handleContactChange} className="input w-full border border-black shadow-md" />
                                    </div>


                                    <div className="col-span-6">
                                        <label htmlFor="contact.Remarks" className="block text-sm font-medium text-gray-700">Remarks</label>
                                        <textarea id="contact.Remarks" name="contact.Remarks" value={formData.contact.Remarks} onChange={handleContactChange} rows="3" className="input w-full border border-black shadow-md" />
                                    </div>
                                </div>
                                ...
                                <div >
                                    ...
                                    <div className="grid grid-cols-6 gap-6 p-2">
                                        <div className="col-span-6 sm:col-span-3">
                                            ...
                                            <input type="text" id="correctAddress.Address" name="correctAddress.Address" value={formData.correctAddress.Address} onChange={handleCorrectAddressChange} className="input w-full border border-black shadow-md" />
                                        </div>
                                        {/* PIN */}
                                        <div className="col-span-6 sm:col-span-3">
                                            <label htmlFor="correctAddress.PIN" className="block text-sm font-medium text-gray-700">PIN</label>
                                            <input type="text" id="correctAddress.PIN" name="correctAddress.PIN" value={formData.correctAddress.PIN} onChange={handleCorrectAddressChange} className="input w-full border border-black shadow-md" />
                                        </div>
                                        {/* City */}
                                        <div className="col-span-6 sm:col-span-3">
                                            <label htmlFor="correctAddress.City" className="block text-sm font-medium text-gray-700">City</label>
                                            <input type="text" id="correctAddress.City" name="correctAddress.City" value={formData.correctAddress.City} onChange={handleCorrectAddressChange} className="input w-full border border-black shadow-md" />
                                        </div>
                                        {/* State */}
                                        <div className="col-span-6 sm:col-span-3">
                                            <label htmlFor="correctAddress.State" className="block text-sm font-medium text-gray-700">State</label>
                                            <input type="text" id="correctAddress.State" name="correctAddress.State" value={formData.correctAddress.State} onChange={handleCorrectAddressChange} className="input w-full border border-black shadow-md" />
                                        </div>
                                        {/* Country */}
                                        <div className="col-span-6 sm:col-span-3">
                                            <label htmlFor="correctAddress.Country" className="block text-sm font-medium text-gray-700">Country</label>
                                            <input type="text" id="correctAddress.Country" name="correctAddress.Country" value={formData.correctAddress.Country} onChange={handleCorrectAddressChange} className="input w-full border border-black shadow-md" />
                                        </div>


                                        <div className="col-span-6">
                                            <label htmlFor="correctAddress.Remarks" className="block text-sm font-medium text-gray-700">Remarks</label>
                                            <textarea id="correctAddress.Remarks" name="correctAddress.Remarks" value={formData.correctAddress.Remarks} onChange={handleCorrectAddressChange} rows="3" className="input w-full border border-black shadow-md" />
                                        </div>
                                    </div>
                                </div>
                            </TabPanel>
                            <TabPanel>
                                <div className="grid grid-cols-6 gap-6 p-2">
                                    ...
                                    <div className="col-span-6 sm:col-span-3">
                                        ...
                                        <select id="gst.registrationType" name="gst.registrationType" value={formData.gst.registrationType} onChange={handleGstChange} className="input w-full border border-black shadow-md">
                                    ...
                                    <div className="col-span-6 sm:col-span-3">
                                        ...
                                        <select id="gst.servicesType" name="gst.servicesType" value={formData.gst.servicesType} onChange={handleGstChange} className="input w-full border border-black shadow-md">
                                    ...
                                    <div className="col-span-6 sm:col-span-3">
                                        ...
                                        <select id="gst.defaultGST" name="gst.defaultGST" value={formData.gst.defaultGST} onChange={handleGstChange} className="input w-full border border-black shadow-md">
                                    ...
                                    <div className="col-span-6 sm:col-span-3">
                                        ...
                                        <input type="text" id="gst.GSTIN" name="gst.GSTIN" value={formData.gst.GSTIN} onChange={handleGstChange} className="input w-full border border-black shadow-md" />
                                    </div>
                                    ...
                                    <div className="col-span-6">
                                        ...
                                        <textarea id="gst.Remarks" name="gst.Remarks" value={formData.gst.Remarks} onChange={handleGstChange} rows="3" className="input w-full border border-black shadow-md" />
                                    </div>
                            ...
                            <TabPanel>
                                <div className="grid grid-cols-6 gap-6 p-2">
                                    ...
                                    <div className="col-span-6 sm:col-span-3">
                                        ...
                                        <input type="text" id="tds.PAN" name="tds.PAN" value={formData.tds.PAN} onChange={handleTdsChange} className="input w-full border border-black shadow-md" />
                                    </div>

                                    {/* TAN No */}
                                    <div className="col-span-6 sm:col-span-3">
                                        <label htmlFor="tds.TANNo" className="block text-sm font-medium text-gray-700">TAN No</label>
                                        <input type="text" id="tds.TANNo" name="tds.TANNo" value={formData.tds.TANNo} onChange={handleTdsChange} className="input w-full border border-black shadow-md" />
                                    </div>

                                    {/* Declaration For */}
                                    <div className="col-span-6 sm:col-span-3">
                                        <label htmlFor="tds.declarationFor" className="block text-sm font-medium text-gray-700">Declaration For</label>
                                        <select id="tds.declarationFor" name="tds.declarationFor" value={formData.tds.declarationFor} onChange={handleTdsChange} className="input w-full border border-black shadow-md">
                                    ...
                                    <div className="col-span-6 sm:col-span-3">
                                        ...
                                        <select id="tds.tdsStatus" name="tds.tdsStatus" value={formData.tds.tdsStatus} onChange={handleTdsChange} className="input w-full border border-black shadow-md">
                                    ...
                                    <div className="col-span-6 sm:col-span-3">
                                        ...
                                        <select id="tds.tdsCode" name="tds.tdsCode" value={formData.tds.tdsCode} onChange={handleTdsChange} className="input w-full border border-black shadow-md">
                                    ...
                                    <div className="col-span-6">
                                        ...
                                        <input type="text" id="tds.natureOfPayment" name="tds.natureOfPayment" value={formData.tds.natureOfPayment} onChange={handleTdsChange} className="input w-full border border-black shadow-md" />
                                    </div>

                                    {/* TDS Section */}
                                    <div className="col-span-6 sm:col-span-3">
                                        <label htmlFor="tds.tdsSection" className="block text-sm font-medium text-gray-700">TDS Section</label>
                                        <input type="text" id="tds.tdsSection" name="tds.tdsSection" value={formData.tds.tdsSection} onChange={handleTdsChange} className="input w-full border border-black shadow-md" />
                                    </div>

                                    {/* Exemption Cert No */}
                                    <div className="col-span-6 sm:col-span-3">
                                        <label htmlFor="tds.exemptionCertNo" className="block text-sm font-medium text-gray-700">Exemption Cert No</label>
                                        <input type="text" id="tds.exemptionCertNo" name="tds.exemptionCertNo" value={formData.tds.exemptionCertNo} onChange={handleTdsChange} className="input w-full border border-black shadow-md" />
                                    </div>

                                    {/* Exemption Limit */}
                                    <div className="col-span-6 sm:col-span-3">
                                        <label htmlFor="tds.exemptionLimit" className="block text-sm font-medium text-gray-700">Exemption Limit</label>
                                        <input type="text" id="tds.exemptionLimit" name="tds.exemptionLimit" value={formData.tds.exemptionLimit} onChange={handleTdsChange} className="input w-full border border-black shadow-md" />
                                    </div>

                                    {/* Valid Upto */}
                                    <div className="col-span-6 sm:col-span-3">
                                        <label htmlFor="tds.validUpto" className="block text-sm font-medium text-gray-700">Valid Upto</label>
                                        <input type="date" id="tds.validUpto" name="tds.validUpto" value={formData.tds.validUpto} onChange={handleTdsChange} className="input w-full border border-black shadow-md" />
                                    </div>

                                    {/* PAN Image */}
                                    <div className="col-span-6 sm:col-span-3">
                                        <label htmlFor="tds.PANImage" className="block text-sm font-medium text-gray-700">PAN Image</label>
                                        <input type="text" id="tds.PANImage" name="tds.PANImage" value={formData.tds.PANImage} onChange={handleTdsChange} className="input w-full border border-black shadow-md" />
                                    </div>
                                    ...
                                    <div className="col-span-6 sm:col-span-3">
                                        ...
                                        <input type="text" id="tds.imageOfDeclaration" name="tds.imageOfDeclaration" value={formData.tds.imageOfDeclaration} onChange={handleTdsChange} className="input w-full border border-black shadow-md" />
                                    </div>


                                    <div className="col-span-6">
                                        <label htmlFor="tds.remarks" className="block text-sm font-medium text-gray-700">Remarks</label>
                                        <textarea id="tds.remarks" name="tds.remarks" value={formData.tds.remarks} onChange={handleTdsChange} rows="3" className="input w-full border border-black shadow-md" />
                                    </div>
