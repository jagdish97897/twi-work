  ...
  return (
    ...
    <form onSubmit={handleSubmit} className="space-y-4 bg-[#FFFFFF] p-2 sm:flex sm:flex-wrap">
      ...
      <div className="w-full sm:w-1/2 flex flex-col sm:pr-4">
          ...
          <input type="text" id="vehiclehire_no" name="vehiclehire_no" value={formData.vehiclehire_no} onChange={handleChange} required className="input w-full border border-black shadow-md" />
        </div>
