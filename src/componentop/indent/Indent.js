...
//     // Automatically set dimensions based on selected vehicle type
//     if (name === 'vehicletype') {
//       switch (value) {
//         case 'TRUCK':
//           updatedItem = { ...updatedItem, DIMENSIONS: '19x7x7'};
//           updatedItem.QUANTUMRATE = 10000; // Auto fill Quantum Rate
//           break;
//         default:
...
//       const dimensions = updatedItem.DIMENSIONS.split('x').map(dimension => parseInt(dimension));
//       const volume = dimensions.reduce((acc, curr) => acc * curr, 1);
//       const effectiveRate = volume; // Assuming some formula to calculate effective rate based on dimensions
//       updatedItem.EFFECTIVERATE = effectiveRate;
//     }
  
//     // Calculate COST
//     const quantumRate = parseFloat(updatedItem.QUANTUMRATE) || 0;
//     const cost = updatedItem.EFFECTIVERATE + quantumRate;
//     updatedItem.COST = cost;
...
//   //   // Calculate EFFECTIVERATE based on DIMENSIONS
//   //   const dimensions = updatedItem.DIMENSIONS.split('x').map(dimension => parseInt(dimension));
//   //   const volume = dimensions.reduce((acc, curr) => acc * curr, 1);
  
//   //   // Assuming some formula to calculate effective rate based on dimensions
//   //   const effectiveRate = volume; // You need to adjust this based on your actual calculation formula
  
//   //   // Set the calculated effective rate
//   //   updatedItem.EFFECTIVERATE = effectiveRate;
  
//   //   // Calculate COST
//   //   const quantumRate = parseFloat(updatedItem.QUANTUMRATE) || 0;
//   //   const cost = effectiveRate + quantumRate;
