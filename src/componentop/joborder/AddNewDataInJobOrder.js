...
function AddNewDataInJobOrder() {
  ...
  return (
    <div className="container mx-auto px-4 py-8 h-screen overflow-y-auto">
      <h2 className="text-2xl font-bold mb-4 text-indigo-800">Add Vehicle Data</h2>
      ...
      <div className='sm:flex sm:flex-wrap gap-4'>
        ...
        <div className="mb-4">
          ...
          <input type="text" id="vehicle_placement_no" name="vehicle_placement_no" value={formData.vehicle_placement_no} onChange={handleChange} required className="input w-full border border-gray-300 rounded-md shadow-sm p-2" />
        </div>
        </div>
        </div>
