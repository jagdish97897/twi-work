...
const JobOrder = () => {
  ...
  useEffect(() => {
    if (jobOrder.vehicleNo) {
      fetchVehicleDetails(jobOrder.vehicleNo);
    }
  }, [jobOrder.vehicleNo]);
