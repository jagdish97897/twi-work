...
//   const handleEdit = (joborderId) => {
//     // Logic to handle editing the job order
//     navigate(`/protected/componentop/sidebarop/Sidebarop/ordermanagement/updateJobOrder/${joborderId}`);
//   };
...
//               <p><strong class="font-bold">Consignor:</strong> ${jobOrder.consignor}</p>
//               <p><strong class="font-bold">Consignee:</strong> ${jobOrder.consignee}</p>
//               <p><strong class="font-bold">From:</strong> ${jobOrder.from}</p>
//               <p><strong class="font-bold">To:</strong> ${jobOrder.to}</p>
//             </div>
//           </div>
//           <div class="flex flex-col text-black border border-black pb-4 h-full w-1/2">
//             <div class="w-full pl-2">
...
//                 <th class="px-2 py-1 text-left text-xs font-small text-black-500 uppercase">Quantum Rate(P/T)</th>
...
//                 <td className="px-4 md:px-6 py-4 whitespace-nowrap">{jobOrder.employee}</td>
//                 <td className="px-4 md:px-6 py-4 whitespace-nowrap">
//                   <button onClick={() => handleEdit(jobOrder._id)} className="text-indigo-600 hover:text-indigo-900"><FaEdit className="mr-1" />Edit</button>
//                   <button onClick={() => handlePrint(jobOrder._id)} className="ml-4 text-green-600 hover:text-green-900"><FaPrint className="mr-1" />Print</button>
//                 </td>
//               </tr>
//             ))}
//           </tbody>
