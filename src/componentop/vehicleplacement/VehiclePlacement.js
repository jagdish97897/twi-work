...
const handleBrokerdetailChange = (e) => {
  ...
  const fetchJobOrderDetails = async (jobOrderNo) => {
    try {
      ...
      const { from, to, dimensions, weight,quantumrate,effectiverate,cost,vehicleNo,broker,owner,loadType,ownerPhone,ownerAddress,brokerPhone,brokerAddress } = response.data;
...
//         </div>
//         <div className="mb-4">
//           <label htmlFor="brokerMobile" className="block text-sm font-medium text-gray-700">Broker Mobile No</label>
//           <input type="text" id="brokerMobile" name="brokerMobile" value={formData.brokerMobile} onChange={handleChange} className="input w-full border border-black shadow-md" />
//         </div>
//       </div>
//     </div>
//   </TabPanel>
...
//                 <div className="mb-4">
//                                 <label htmlFor="vehicleNo" className="block text-sm font-medium text-gray-700">Vehicle No</label>
//                                 <input type="text" id="vehicleNo" name="vehicleNo"  onChange={handleChange} className="input w-full border border-black shadow-md" />
//                             </div>
//                 <div className="mb-4">
